...
import shopImage from "../assets/images/tarte-framboise.png"
import shopImage1 from "../assets/images/framboise-lait-amandes.png"
import shopImage2 from "../assets/images/le-fraise-vanille.png"
const ContentShop1 = () => {
  return (
              ...
              <ul className="collapse show list-unstyled pl-3">
                <li>
                  <p className="profilshop">
                    ...
                    alors n'hésitez plus... pas de livraison..... les commandes
                    sont a récupérer sur noisy-le-sec (93)
                  </p>
                </li>
              </ul>
            </li>
            ...
            <div className="col-md-4">
              <div className="card mb-4 product-wap rounded-0">
                <div className="card rounded-0">
                  <Image
                    className="card-Image rounded-0 Image-fluid"
                    src={shopImage}
                    alt="tarte"
                  />
                  <div className="card-Image-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
